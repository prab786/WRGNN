...
def load_articles(obj):
    ...
    # Load CSV files
    train_df = pd.read_csv(f"{obj}/train.csv")
    dev_df = pd.read_csv(f"{obj}/dev.csv")
    test_df = pd.read_csv(f"{obj}/test.csv")
    #print(dev_df)
    ...
    x_train, y_train = dataset["train"]["text_a"], dataset["train"]["label"]
    x_test, y_test = dataset["validation"]["text_a"], dataset["validation"]["label"]
    x_test_res = dataset["test"]["text_a"]
...
# x_train, x_test, x_test_res, y_train, y_test, y_test_res, x_train_graph, x_test_graph, x_test_res_graph=load_articles()
# print(y_test_res)
