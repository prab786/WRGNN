...
parser.add_argument('--model_name', default='BERT-WRGNN', type=str)
...
def train_model(tokenizer, max_len, n_epochs, batch_size, datasetname, iter):
    ...
    for epoch in range(n_epochs):
        ...
        for Batch_data in tqdm(train_loader):
            ...
            loss = sup_criterion(ogbi, targets) 
            optimizer.zero_grad()
            loss.backward()
    ...
    torch.save(model.state_dict(), 'checkpoint_new/'+'BERT_WRGNN_' + datasetname + '_iter' + str(iter) + '.m')
